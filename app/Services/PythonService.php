...
class PythonService
{
    ...
    {
        system('python3.5 python/admin_train_P2.py');
    }
	...
	ini_set('max_execution_time',-1);
        ...
        // dd("".$var1." ".$var2." ".$var3." ".$var4." ". $var5);
        $output = null;
        //$dato = system('python3.5 python/predecirTiempoViajeOk.py '.$var1.' '.$var2.' '.$var3.' '.$var4.' '.$var5, $output);
        $dato = shell_exec('python3.5 python/predecirTiempoViajeOk.py '.$var1.' '.$var2.' '.$var3.' '.$var4.' '.$var5);
	//dd($dato);
	return [$dato, $output];
    }
}

...
def conect():
    conn_string ="host='127.0.0.1' port='54320' dbname='admingeso' user='homestead' password='secret'"
...
def leer_todos_csv():
    ...
    archivos = open("nombres_csv_procesar.txt",'rb')
...
def main():
    ...
    print ("Numero de puntos a procesar: "+str(len(records2)))
    print (records2[0])
    
    l_recorridos = iterarDatos(records)
    l_recorridos_filtrados = filtrarDatos(l_recorridos)
    conn.close()
    l_recorridos2 = iterarDatos(records2)
    l_recorridos2_filtrados = filtrarDatos(l_recorridos2)
    ...
    print ("######RECORRIDOSDB######")
    print ("Lista de recorridos anteior")
    print(len(lista_recorridos2))
    print ("Lista de recorridos filtrada")
    print (len(l_recorridos2_filtrados))
    print ("#########################")
